...
namespace Microsoft.WebCore.Html
{
    /// <summary>
    ...
    /// <summary>
    /// Case insensitive, strongly typed dictionary with string keys and <typeparamref name="TValue"/> values that can be initialised using lambdas.
    /// </summary>
    ...
    public class Hash<TValue> : Dictionary<string, TValue>
    {
        ...
        /// <summary>
        /// Creates an empty case insensitive dictionary of <see cref="string"/> keys and <typeparam name="TValue" /> values.
        /// </summary>
    ...
    {
        /// <summary>
        /// Extension Method to initialize an <see cref="Dictionary{TKey,TValue}"/>
        /// </summary>
        ...
        /// <summary>
        /// Extension Method to initialize an <see cref="IDictionary"/>
        /// </summary>
        /// <param name="dict"></param>
        /// <param name="hash">The key / value pairs to add to the dictionary.</param>
        /// <returns>The the dictionary.</returns>
        ...
        public static string ToHtmlAttributes(IDictionary<string, object> attributes)
        {
            ...
            return attributesEncoded.JoinString(" "); //string.Join(" ", attributesEncoded.ToArray());
        }
    }
}
