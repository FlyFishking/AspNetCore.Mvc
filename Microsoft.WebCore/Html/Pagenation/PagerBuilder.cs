    ...
    internal class PagerBuilder
    {
        ...
        public string GenerateHtml()
        {
            ...
            if ((_pageIndex > _totalPageCount && _totalPageCount > 0) || _pageIndex < 1)
            {
                ...
                {
                    return string.Format("{0}<div data-ajax=\"true\" data-ajax-update=\"{1}\" data-invalidpageerrmsg=\"{2}\" data-outrangeerrmsg=\"{3}\" data-pagerid=\"AjaxPager.MvcPager\" style=\"color:red;font-weight:bold\">{3}</div>{0}",
                ...
                return string.Format("{0}<div data-invalidpageerrmsg=\"{1}\" data-outrangeerrmsg=\"{2}\" data-pagerid=\"AjaxPager.MvcPager\" style=\"color:red;font-weight:bold\">{2}</div>{0}",
        ...
        private void AddDataAttributes(IDictionary<string, object> attrs)
        {
            ...
            attrs.Add("data-pagerid", "AjaxPager.MvcPager");
            if (_pageIndex > 1)
