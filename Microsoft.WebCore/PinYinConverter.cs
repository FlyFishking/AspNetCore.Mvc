...
namespace Microsoft.WebCore
{
    /// <summary>
    /// 支持所有GB2312字符集中的汉字
    /// 遗留问题：不能区分多音字,只完全支持GB2312-80汉字库，
    ///           如果是多音字，只能得到最后一个列表中的拼音。
    ///           如果想支持多音字，建议用词库资源库的方式进行匹配。
    /// </summary>
    public class PinYinConverter
    {
        ...
        public static string GetFirstLetters(string str)
        {
            ...
            foreach (var chr in chs)
                result.Append(GetFirstLetters(chr));
        ...
        /// <param name="ch"></param>        
        /// <returns></returns>        
        private static string GetFirstLetters(char ch)
        {
            var py = ConvertSingleChar(ch);
            if (!string.IsNullOrEmpty(py)) py = py.Substring(0, 1);
            return py;
        }
        ...
        public static string GetLetters(string str)
        {
            ...
            var chs = str.ToCharArray();
            foreach (var chr in chs)
                result.Append(ConvertSingleChar(chr));
            return result.ToString();
        }
        ...
        /// <param name="ch"></param>
        /// <returns></returns>
        private static string ConvertSingleChar(char ch)
        {
            // 拉丁字符
                ...
                for (var aPos = 11; aPos >= 0; aPos--)
                {
                    ...
                    if (chr >= pyCode[aboutPos])
                    {
                        ...
                        for (var i = aboutPos + 32; i >= aboutPos; i--)
                            if (pyCode[i] <= chr) return pyName[i];
                        break;
                    }
                }
            }
            ...
            {
                var pos = Array.IndexOf(specialChinese, ch.ToString());
                if (pos != decimal.MinusOne) return specialChinesePinYin[pos];
            }
...
//            var i = 0;
//            var strResult = new StringBuilder(gbkBytes.Length);
//            while (i < gbkBytes.Length)
//                //如果为数字\字母\其他ASCII符号
//                if (gbkBytes[i] <= 127)
//                {
//                    strResult.Append((char)gbkBytes[i]);
//                    i++;
//                }
//                else
//                {
...
//        /// <param name="str">汉字字符串</param>
//        /// <returns>转换后的拼音(全拼)字符串</returns>
//        public static string GetAllPinYinLetters(string str)
//        {
//            //验证是否输入汉字
//            var regex = new Regex("^[\u4e00-\u9fa5]$");
//            var array = new byte[2];
//            var noWChar = str.ToCharArray();
//            var pyString = new StringBuilder(noWChar.Length * 10);
//            foreach (var chr in noWChar)
//            {
//                if (regex.IsMatch(chr.ToString()))
//                {
//                    array = Encoding.Default.GetBytes(chr.ToString());
//                    int chr1 = array[0];
//                    int chr2 = array[1];
//                    var chrAsc = chr1 * 256 + chr2 - 65536;
...
//                                break;
//                            case -5659:
//                                pyString.Append("Tian");
//                                break;
//                            default:
//                                for (var i = pyCode.Length - 1; i >= 0; i--)
//                                {
//                                    if (pyCode[i] > chrAsc) continue;
//                                    //如果不超出范围则获取对应的拼音
...
//        }
        ...
        private static readonly int[] pyCode =
        {
        ...
        /// 二级汉字数组
        /// </summary>
        private static readonly string[] specialChinese =
        {
        ...
        /// 二级汉字对应拼音数组
        /// </summary>
        private static readonly string[] specialChinesePinYin =
        {
